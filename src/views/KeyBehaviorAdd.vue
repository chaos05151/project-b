    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                ...
                <el-breadcrumb-item>新增关键行为</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
            <el-form  :model="form">
                ...
                :label="'广告播放'"
                :key="item.id"
                @change="changeInputValue('ad_play',index)"
                >
                     <div class="text">
                        <div>
                            <span>自启动起</span>
...
<script setup>
    ...
    import {AddKeyBehavior,getKeyBehaviorTypeList} from '../api/risk'
...
//修改输入值
    const  changeInputValue=(key,index)=>{
        console.log(key,index);
        console.log(form[key][index].start_in+0);
