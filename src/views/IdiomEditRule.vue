    ...
    <div>
        ...
        <div class="container">
            <div class="form-box">
                <div>
                    <el-breadcrumb separator="/">
                        <el-breadcrumb-item v-show="this.$route.params.whichTab == 0">闯关红包</el-breadcrumb-item>
                        <el-breadcrumb-item v-show="this.$route.params.whichTab == 1">激励红包</el-breadcrumb-item>
                        <el-breadcrumb-item v-show="this.$route.params.whichTab == 2">免费领钱</el-breadcrumb-item>
                ...
                <el-form ref="formRef" :rules="rules" :model="form" label-width="80px">
                    ...
                    <el-form-item v-show="this.$route.params.whichTab == 0" label-width="100px" label="激励视频翻倍">
                        <el-input style="width: 160px" class="w-50 m-2" size="small" v-model="form.double_multiple">
                        </el-input>&emsp;倍
                    </el-form-item>
                    <el-form-item>
...
export default {
    ...
    setup() {
        ...
        form.id = data.id
        form.balancefrom = data.balancefrom;
        form.balanceto = data.balanceto;
        form.distribute_moneyfrom = data.distribute_moneyfrom;
        form.distribute_moneyto = data.distribute_moneyto;
        form.distribute_moneyconstant = data.distribute_moneyconstant;
        form.double_multiple = data.double_multiple;
        const rules = {
            ...
            formRef.value.validate((valid) => {
                if (valid) {
                    ...
                    if (this.$route.params.whichTab == 0) {
                        editFirstTabData(form.id, data);

                    } else if (this.$route.params.whichTab == 1) {
                        editSecondTabData(form.id, datatwo);
                    } else {
                        editThirdTabData(form.id, datatwo);
                    }
